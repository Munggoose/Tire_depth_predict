...
class OutLayer2(nn.Module):
    def __init__(self,in_c,hidden_c):
        ...
        self.act1 = nn.ReLU6()
        self.act2 = nn.ReLU6()
        self.linear1 = nn.Linear(hidden_c,hidden_c//2)
        self.act3 = nn.GELU()
        self.linear2 = nn.Linear(hidden_c//2,hidden_c//4) 
        self.linear3 = nn.Linear(hidden_c//4,hidden_c//8)
        self.bn3 = nn.BatchNorm1d()
        self.bn4 = nn.BatchNorm1d()
        self.act4 = nn.GELU()
        self.proj = nn.Linear(hidden_c//8,hidden_c//1)
